...
module.exports = (express) => {
  ...
  router.get('/api', (req, res) => {
    util.debug('info', '/api endpoint accessed successfully', ['9', __filename], res.statusCode, null);
    res.send(
      `\n** Still more to go\n\n
  ...
  router.get('/api/v1', (req, res) => {
    util.debug('info', '/api/v1 endpoint accessed successfully', ['16', __filename], res.statusCode, null);
    res.send(
